...
readonly PASSWORD_MIN_LENGTH="${PASSWORD_MIN_LENGTH:-8}"
readonly REQUIRED_STRONG_PASSWORD="${REQUIRED_STRONG_PASSWORD:-false}"
readonly BACKUP_PATH="${BACKUP_PATH:-/tmp/user_manager_backups}"
